...
export default () => {
    ...
    const style = {
        backgroundImage: animal.image ? `url(${animal.image})` : "url(https://avatars.mds.yandex.net/i?id=70ff2185c8bf639658340a90dacd0f0df8575912-8205921-images-thumbs&n=13)"
    }
